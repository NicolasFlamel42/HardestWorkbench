...
public class CrudeWorkbenchMenu extends AbstractContainerMenu {
    public final CrudeWorkbenchBlockEntity blockEntity;
    private final Level level;

    public CrudeWorkbenchMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.CRUDE_WORKBENCH.get());
    }
